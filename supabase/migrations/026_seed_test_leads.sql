...
values
  ('c1000001-0000-0000-0000-000000000001', 'Alice',   'Martin',   'alice@acme.com',      '3101234001', '[TEST] Acme Printing',      'Retail',         'hot'),
  ('c1000001-0000-0000-0000-000000000002', 'Bob',     'Chen',     'bob@bravo.com',       '3101234002', '[TEST] Bravo Signs',        'Signage',        'warm'),
  ('c1000001-0000-0000-0000-000000000003', 'Carlos',  'Rivera',   'carlos@charlie.com',  '3101234003', '[TEST] Charlie Labels',     'Manufacturing',  null),
  ('c1000001-0000-0000-0000-000000000004', 'Diana',   'Lee',      'diana@delta.com',     '3101234004', '[TEST] Delta Apparel',      'Apparel',        'warm'),
  ('c1000001-0000-0000-0000-000000000005', 'Evan',    'Gomez',    'evan@echo.com',       '3101234005', '[TEST] Echo Events',        'Events',         null),
  ('c1000001-0000-0000-0000-000000000006', 'Fatima',  'Hassan',   'fatima@foxtrot.com',  '3101234006', '[TEST] Foxtrot Corp',       'Corporate',      'hot'),
  ('c1000001-0000-0000-0000-000000000007', 'George',  'Tanaka',   'george@golf.com',     '3101234007', '[TEST] Golf Promos',        'Promotions',     null),
  ('c1000001-0000-0000-0000-000000000008', 'Hannah',  'Wright',   'hannah@hotel.com',    '3101234008', '[TEST] Hotel Supplies',     'Hospitality',    'warm')
...
values
  -- Pending
  ('l1000001-0000-0000-0000-000000000001', 'c1000001-0000-0000-0000-000000000001',
   'Walk-in', 'High', 'Pending', false,
   '{"Stickers": true, "Labels": true}',
   'Customer walked in asking about bulk sticker orders. Very keen.'),

  ('l1000001-0000-0000-0000-000000000002', 'c1000001-0000-0000-0000-000000000002',
   'Website', 'Medium', 'Pending', false,
   '{"Banners": true, "Flyers": true}',
   'Came through the website inquiry form.'),

  ('l1000001-0000-0000-0000-000000000003', 'c1000001-0000-0000-0000-000000000003',
   'Referral', 'Low', 'Pending', false,
   '{"Boxes": true}',
   null),

  -- Validated (SDR is actively working)
  ('l1000001-0000-0000-0000-000000000004', 'c1000001-0000-0000-0000-000000000004',
...
values
  ('l1000001-0000-0000-0000-000000000005', 'c1000001-0000-0000-0000-000000000005',
  ...
  ('l1000001-0000-0000-0000-000000000006', 'c1000001-0000-0000-0000-000000000006',
...
values
  ('l1000001-0000-0000-0000-000000000007', 'c1000001-0000-0000-0000-000000000007',
   'Manual', 'High', 'Routed to Sales', 'Ongoing', false,
   1250.00, 'Email',
   'Verbally quoted $1250 for 500 branded tote bags. Ready for Sales to follow up.'),

  ('l1000001-0000-0000-0000-000000000008', 'c1000001-0000-0000-0000-000000000008',
...
values
  ('l1000001-0000-0000-0000-000000000009', 'c1000001-0000-0000-0000-000000000003',
