...
import { resolveTicketShippingDestinationsForDisplay } from "@/lib/utils/ticket-shipping-destinations";
    ...
    admin
      ...
      .select(
        `id, ticket_kind, ticket_status, title, reference_code, created_at,
         ...
         quote_payment_types, quote_channel, order_source, created_by_id,
